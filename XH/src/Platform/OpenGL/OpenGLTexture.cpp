...
namespace XH
{
        ...
        :m_Path(path)
    {
        ...
        {
            // XH_PROFILE_SCOPE("stbi_load - OpenGLTexture2D::OpenGLTexture2D(const std::string&)");
        ...
        if (data)
        {
            ...
            XH_CORE_ASSERT(internalFormat & dataFormat, "Format not supported!");
    ...
    void OpenGLTexture2D::SetData(void* data, uint32_t size)
    {
        ...
        XH_CORE_ASSERT(size == m_Width * m_Height * bpp, "Data must be entire texture!");
