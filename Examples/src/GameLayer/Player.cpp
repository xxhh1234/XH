...
Player::Player()
{
    ...
    m_EngineParticle.ColorBegin = { 254.0f/255.0f, 109.0f/255.0f, 41.0f/255.0f, 1.0f };
    m_EngineParticle.ColorEnd =   { 254.0f/255.0f, 212.0f/255.0f, 123.0f/255.0f, 1.0f };
    m_EngineParticle.LifeTime = 1.0f;
}

void Player::LoadAssets()
{
    m_ShipTexture = XH::Texture2D::Create("assets/textures/Ship.png");
}

void Player::OnUpdate()
{
    m_Time += XH::Time::deltatime;
    if (XH::Input::IsKeyPressed(XH::Key::Space))
    {
    ...
    m_Position += m_Velocity * XH::Time::deltatime;
...
void Player::OnRender()
{
    ...
    XH::Renderer2D::DrawQuad({ m_Position.x, m_Position.y, 0.5f }, { 1.0f, 1.3f }, m_ShipTexture, GetRotation());
}
